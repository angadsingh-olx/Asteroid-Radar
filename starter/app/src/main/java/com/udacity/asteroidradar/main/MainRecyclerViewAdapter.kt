...
class MainRecyclerViewAdapter(val itemClickListener: OnItemClickHandler): ListAdapter<Asteroid, MainRecyclerViewAdapter.MainRecyclerViewHolder>(DiffCallback) {
