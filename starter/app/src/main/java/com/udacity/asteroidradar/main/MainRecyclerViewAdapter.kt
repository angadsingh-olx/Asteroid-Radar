...
class MainRecyclerViewAdapter(val itemClickListener: OnItemClickListener): ListAdapter<Asteroid, MainRecyclerViewAdapter.MainRecyclerViewHolder>(DiffCallback) {
